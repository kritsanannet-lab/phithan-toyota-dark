...
(function () {
  ...
  /* All scroll-driven cinematic animation now lives in js/cinematic.js
     (GSAP ScrollTrigger). Content is visible by default — if that script or
     GSAP fails to load, nothing is ever left hidden. */
})();
